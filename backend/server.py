...
async def seed_data():
    ...
    try:
        ...
        admin_exists = await db.get_user_by_email("admin@nature.com")
        if not admin_exists:
            admin_user = {
                "id": str(uuid.uuid4()),
        ...
        sample_lands = [
            {
                "id": str(uuid.uuid4()),
                "title": "Ramanagara Sericulture Farm & Silk Land",
                "description": "Exquisite farming land located in Ramanagara district, famous for its rich soil and silkworm rearing. Features rolling terrain, mature mulberry groves, perimeter fencing, and high-flow tube well. Perfect for organic farming, dairy, or a country farmhouse.",
                "property_type": "land",
                "property_subtype": "ranches",
                "price": 14500000.0,
                "price_type": "sale",
                "city": "Ramanagara",
                "county": "Ramanagara District",
                "state": "KA",
                "zip_code": "562159",
                "address": "Kempegowda Highway",
                "bedrooms": 0,
                "bathrooms": 0,
                ...
                "builder_info": "Premium Ramanagara land and estate specialists.",
                "is_featured": True,
                "is_active": True,
                "created_at": datetime.now(timezone.utc),
                "interest_count": 0,
                "soil_type": "Mulberry Fertile Red Soil",
                "water_source": "Tube Well",
                "crop_history": "Mulberry & Organic Vegetables",
            ...
            {
                "id": str(uuid.uuid4()),
                "title": "Kanva Riverfront Coconut Grove",
                "description": "Beautiful coconut grove fronting the scenic Kanva reservoir canal in Ramanagara. Complete with underground drip irrigation, farm equipment shed, and perfect farmhouse site. Fully accessible via paved county roads.",
                "property_type": "land",
                ...
                "amenities": ["Underground Drip Irrigation", "Deep Borewell", "Equipment Shed", "Power Hookup", "Paved Road Access"],
                "floor_plan_url": "",
                "virtual_tour_url": "",
                "builder_name": "Direct Land Sales",
                "builder_info": "Specialists in productive Ramanagara agricultural plots.",
                "is_featured": True,
                "is_active": True,
                "created_at": datetime.now(timezone.utc),
                "interest_count": 0,
                ...
                "crop_history": "Coconuts & Banana Plantation",
            ...
            {
                "id": str(uuid.uuid4()),
                "title": "Closepet Granite Hills Eco-Retreat & Farm",
                "description": "Spectacular rocky terrain land bordering the famous Closepet Granite Hills in Ramanagara (Sholay shooting location). Features majestic boulders, teakwood plantation, and natural springs. Ideal for an off-grid eco-resort or farm retreat.",
                "property_type": "land",
                ...
                "created_at": datetime.now(timezone.utc),
                "interest_count": 0,
                "soil_type": "Granite Gravelly Soil",
                "water_source": "Natural Springs",
                "crop_history": "Teak & Silver Oak Timber",
                "fencing": "None",
                "road_width_ft": 15,
                "video_url": "https://cdn.pixabay.com/video/2021/08/04/83861-584742517_large.mp4"
            },
            {
                "id": str(uuid.uuid4()),
                "title": "Janapada Loka Heritage Farm Land",
                "description": "Premium fertile acreage near the Janapada Loka heritage site. Perfect setting for organic vegetables, mango plantation, or building a weekend farmhouse. Includes borewell connection, power lines, and tar road access.",
                "property_type": "land",
                ...
                "amenities": ["Borewell Water Connection", "Tar Road Frontage", "Lush Meadows", "Electricity at Line", "Year-round Access"],
                "floor_plan_url": "",
                "virtual_tour_url": "",
                "builder_name": "Direct Land Sales",
                ...
                "crop_history": "Organic Ragi & Maize",
            ...
            {
                "id": str(uuid.uuid4()),
                "title": "Ramanagara Mulberry Orchard & Valley Plot",
                "description": "Breathtaking high-value parcel nestled in the valley overlooking Ramanagara hills. Cultivated with mulberry plants and silver oak trees. Ideal for investment, sericulture, or a private country villa.",
                "property_type": "land",
                ...
                "state": "KA",
                "zip_code": "562159",
                "address": "Ramanagara Silk Market Road",
                "bedrooms": 0,
                "bathrooms": 0,
                ...
                "amenities": ["Hill Views", "Mulberry Plantation", "Access Road", "Electric Nearby", "No HOA"],
                "floor_plan_url": "",
                "virtual_tour_url": "",
                "builder_name": "Direct Land Sales",
                "builder_info": "Curators of premium Ramanagara valley lands.",
                "is_featured": False,
                "is_active": True,
                "created_at": datetime.now(timezone.utc),
                "interest_count": 0,
                "soil_type": "Loamy Valley Soil",
                "water_source": "Local Water Connection",
                "crop_history": "Mulberry Cultivation",
                "fencing": "None",
                "road_width_ft": 20,
                "video_url": "https://cdn.pixabay.com/video/2021/08/04/83861-584742517_large.mp4"
            },
            {
                "id": str(uuid.uuid4()),
                "title": "Channapatna Border Organic Farm Plot",
                "description": "Excellent agricultural land near the Ramanagara-Channapatna border. Rolling soil, fully irrigated, highly suited for crop rotation, fruit trees, and organic farming. Borders state highway.",
                "property_type": "land",
                ...
                "state": "KA",
                "zip_code": "562160",
                "address": "Closepet Granite Hills",
                "bedrooms": 0,
                "bathrooms": 0,
                ...
                "amenities": ["Mango Orchard", "State Highway Frontage", "Flat Irrigated Terrain", "Drip System Installed"],
                "floor_plan_url": "",
                "virtual_tour_url": "",
                "builder_name": "Direct Land Sales",
                ...
                "crop_history": "Mango & Guava Orchard",
